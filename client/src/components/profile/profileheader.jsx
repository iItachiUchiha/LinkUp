        ...
        <div>
          ...
          <div className={classes.description}>
            ...
            <div style={{ display: "flex" }}>
              {posts && (
                <p style={{ paddingRight: "15px" }} className={classes.posts}>
                  {posts.length} Posts
                </p>
              )}
              <p
              ...
              <p
                ...
                onClick={() => {
                  if (following) {
                    openDialog.setOpenfollowingdialog(true);
                  }
                }}
              >
            ...
            {user._id != auth.user.user._id &&
              !auth.user.user.following.includes(user._id) &&
              !notification.notifications.status.includes(user._id) && (
                <div
                  className={classes.button}
                  style={{
                    display: "flex",
