...
const ChangeDetails = ({ setChange }) => {
  ...
  const formSchema = Yup.object().shape({
    email: Yup.string().email("Email is invalid").default(auth.user.email),
    bio: Yup.string()
      .max(200, "Bio must not be more than 200 characters")
      .default(auth.user.bio),
    name: Yup.string().default(auth.user.name),
  });
      ...
      <div className={classes.editProfile}>
        <div className={classes.change}>
          <div className={classes.header}>
            ...
            ></img>
            <div>
              <h2 style={{ paddingBottom: "0px", marginBottom: "0px" }}>
                {auth.user.user.name}
              </h2>
              <p
                style={{
          ...
          <form onSubmit={handleSubmit(submitHandler)}>
            ...
            <div className={classes.footer}>
              ...
              {loading && (
                <div className={classes.button1} disabled={disabled}>
                  Loading...
                </div>
              )}
              <p
